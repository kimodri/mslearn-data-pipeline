...
$ResourceGroupName = 'data-pipeline-project'
$SA_NAME = "mslearnfuncstorage"
$FUNCION_APP_NAME = 'dailyuploadfunc'
$Location = 'southeastasia' # To see a list of all locations use: az account list-locations
...
# Create function app
az functionapp create --resource-group $ResourceGroupName --consumption-plan-location $Location --runtime python --runtime-version 3.13 --functions-version 4 --name $FunctionAppName --os-type linux --storage-account $StorageAccountName
